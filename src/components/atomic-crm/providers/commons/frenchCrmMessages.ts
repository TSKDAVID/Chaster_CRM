...
export const frenchCrmMessages = {
  ...
  crm: {
    ...
    profile: {
      inbound: {
        description:
          "Vous pouvez commencer à envoyer des e-mails vers l'adresse de réception de votre serveur, par exemple en l'ajoutant au champ %{field}. Chaster traitera les e-mails et ajoutera des notes aux contacts correspondants.",
