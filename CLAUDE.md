...
```bash
make test-app         # Run app unit tests (vitest)
make test-functions   # Run edge function unit tests
...
> **Warning:** If `registry.json` misses changes you made, you MUST update `scripts/generate-registry.mjs` to include those changes.
